...
import * as CompactButton from '@/components/new-ui/compact-button';
...
function hasModalTitle(children: React.ReactNode): boolean {
  let found = false;
