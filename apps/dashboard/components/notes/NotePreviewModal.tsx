...
import type { Note, TranscriptSegment } from "@/lib/data/notes"
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[1200px] p-0 gap-0 max-h-[90vh] overflow-hidden rounded-2xl">
        <DialogHeader className="sr-only">
          <DialogTitle>Not Önizleme</DialogTitle>
        </DialogHeader>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    {format(note.addedDate, "h:mm a")} · Çevir
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {isAudioNote && note.audioData ? (
                ...
                <div className="text-sm text-muted-foreground">
                  {note.content || "Bu not için içerik bulunmuyor."}
                </div>
              )}
            </div>
          </div>
