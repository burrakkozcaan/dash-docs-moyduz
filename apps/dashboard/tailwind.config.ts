...
const config = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      'ln-label-lg': [
        '1.125rem',
        { lineHeight: '1.75rem', letterSpacing: '-0.015em', fontWeight: '500' },
      ],
      'ln-label-md': [
        '1rem',
      ...
      'ln-label-xs': [
        '0.75rem',
        { lineHeight: '1rem', letterSpacing: '0em', fontWeight: '500' },
      ],
      'ln-paragraph-lg': [
        '1.125rem',
        { lineHeight: '1.75rem', letterSpacing: '-0.015em', fontWeight: '400' },
      ],
      'ln-paragraph-md': [
        '1rem',
      ...
      'ln-paragraph-xs': [
        '0.75rem',
        { lineHeight: '1rem', letterSpacing: '0em', fontWeight: '400' },
      ],
      'ln-subheading-xs': [
        '0.6875rem',
        { lineHeight: '0.625rem', letterSpacing: '0em', fontWeight: '550' },
      ],
      'ln-title-h5': [
        '1.5rem',
        { lineHeight: '2rem', letterSpacing: '-0.02em', fontWeight: '550' },
      ],
      'ln-title-h6': [
        '1.25rem',
        { lineHeight: '1.75rem', letterSpacing: '-0.02em', fontWeight: '550' },
      ],
      inherit: 'inherit',
      /* Varsayılan Tailwind font boyutları (text-xs, text-4xl vb. için) */
    ...
    boxShadow: {
      ...
      'ln-subheading':
        '0 4px 8px rgba(41,41,41,.06), 0 2px 4px rgba(41,41,41,.04), 0 1px 2px rgba(41,41,41,.04), 0 0 0 1px rgba(41,41,41,.08), inset 0 -.5px .5px rgba(41,41,41,.08)',
      'ln-toggle-active':
        '0 4px 8px rgba(41,41,41,.06), 0 2px 4px rgba(41,41,41,.04), 0 1px 2px rgba(41,41,41,.04), inset 0 -0.5px 0.5px rgba(41,41,41,.08)',
      'ln-button-white': '0 1px 2px rgba(0,0,0,.06), 0 1px 3px rgba(0,0,0,.04)',
      'ln-button-orange':
        '0 2px 4px rgba(240,80,35,.2), 0 1px 2px rgba(240,80,35,.12)',
      'ln-badge-gray':
        '0 0 0 1px rgba(61,61,61,.12), 0 0.75px 0.75px inset rgba(255,255,255,.64)',
      'ln-badge-orange':
        '0 0 0 1px rgba(240,80,35,.16), 0 -0.5px 0.5px inset rgba(255,255,255,.64)',
    ...
    extend: {
      ...
      animation: {
        ...
        'marquee-vertical':
          'marquee-vertical var(--marquee-duration, 22s) linear infinite',
        'marquee-horizontal':
          'marquee-horizontal var(--marquee-duration, 35s) linear infinite',
        orbiting: 'orbiting calc(var(--duration) * 1s) linear infinite',
        'deploy-scroll': 'deploy-scroll 18s linear infinite',
      },
      keyframes: {
        'accordion-down': {
        ...
        'marquee-horizontal': {
          ...
          to: { transform: 'translateX(calc(-100% - var(--marquee-gap, 0.625rem)))' },
        },
        orbiting: {
          from: {
            transform:
              'rotate(calc(var(--angle, 0) * 1deg)) translateX(calc(var(--radius, 200) * 1px)) rotate(calc(-1 * var(--angle, 0) * 1deg))',
          },
          to: {
            transform:
              'rotate(calc(360 + var(--angle, 0) * 1deg)) translateX(calc(var(--radius, 200) * 1px)) rotate(calc(-360 - var(--angle, 0) * 1deg))',
          },
        },
        'deploy-scroll': {
