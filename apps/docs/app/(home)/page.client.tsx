...
export function CreateAppAnimation() {
  const installCmd = 'Önce aşamalı sorular soruyoruz sonra size en uygun ürünü kişiselleştiriyoruz';
  const tickTime = 100;
    ...
    >
      ...
      <pre className="overflow-hidden rounded-xl border text-sm shadow-lg bg-fd-card">
        <div className="flex flex-row items-center gap-2 border-b px-4 py-2">
          <PanelTop className="size-4" /> <span className="font-bold">Üretim aşaması</span>
          <div className="grow" />
...
const WritingTabs = [
  {
    name: 'En iyi e-ticaret paketleri',
    value: 'writer',
  },
  {
    name: 'Developer',
...
export function AgnosticBackground() {
  ...
  return (
    ...
    >
      <Dithering
        colorBack="#00000000"
        colorFront={resolvedTheme === 'dark' ? '#fc7744' : '#d06412ff'}
        shape="warp"
        type="4x4"
        speed={visible ? 0.4 : 0}
        className="size-full"
