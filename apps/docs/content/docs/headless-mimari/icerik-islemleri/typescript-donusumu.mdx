---
title: TypeScript'ten JavaScript'e (Remark TS to JS)
description: TypeScript kod bloklarını otomatik olarak JavaScript sekmeleriyle birlikte oluşturan eklenti.
---
