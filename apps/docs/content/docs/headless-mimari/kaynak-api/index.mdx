...
- Generate [page slugs and page tree](/docs/headless-mimari/sayfa-kurallari).
...
You can use it with content sources like Fumadocs MDX, see [`source`](/docs/headless-mimari/kaynak-api/kaynak) for details.
...
Load the [icon](/docs/headless-mimari/sayfa-kurallari#icons) property specified by page and meta files.
...
If translations are missing for a page, it fallbacks to [`fallbackLanguage`](/docs/headless-mimari/coklu-dil#fallback-language).
