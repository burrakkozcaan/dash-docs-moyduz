    ...
    >
      ...
      >
        ...
        >
             ...
             <h2 className="text-foreground text-center text-[20px] md:text-xl font-medium">
            Trusted by High-Growth Digital Brands Worldwide{" "}
          </h2>
          <p className="text-muted-foreground text-[14px] m-2 md:text-lg text-center w-full md:max-w-[700px] leading-[1.5] md:leading-relaxed px-6 md:px-0">
                    ...
                    return (
                      ...
                      >
                        <div className="logo-item flex items-center gap-2 md:gap-3">
                          <div className="grid place-items-center h-9 w-9 md:h-11 md:w-11 text-foreground">
                            <Icon
