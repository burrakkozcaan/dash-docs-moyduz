...
const OnboardCard = ({
  ...
  return (
    ...
    >
      <div className="flex min-w-[250px] scale-[0.9] flex-col justify-center gap-2 rounded-md border border-neutral-800 bg-gradient-to-br from-neutral-900 to-black py-2 pl-3 pr-16 opacity-80">
      ...
      <div className="flex min-w-[250px] flex-col justify-center gap-2 rounded-md border border-neutral-800 bg-gradient-to-br from-neutral-900 to-black py-2 pl-3 pr-16">
      ...
      <div className="absolute top-0 h-[40%] w-full [background-image:linear-gradient(to_bottom,rgb(0,0,0)_20%,transparent_100%)]" />
      <div className="absolute bottom-0 h-[40%] w-full [background-image:linear-gradient(to_top,rgb(0,0,0)_20%,transparent_100%)]" />
    </div>
  );
};
